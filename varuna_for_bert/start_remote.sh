...
do
    ...
    ssh "${machines[i]}" "echo sshed; cd ~/t-nisar/Varuna/varuna_for_bert; source ~/anaconda3/bin/activate varuna; echo \$SQUAD_DIR; GLOO_SOCKET_IFNAME=eth0 python $mid $3" > my_ssh_out_$i  2>my_ssh_err_$i &
    i=$(($i+1))
done
