...
do
    ...
    sudo ssh -o StrictHostKeyChecking=no -i /home/varuna/.ssh/vdummy.pem "varuna@${reachable_machines[i]}" "echo sshed; cd /home/varuna/t-saathl/Varuna/Megatron-LM ; bash examples/pretrain_gpt2.sh $reachable_count $i $master_addr $ckpt" > ssh_logs/my_ssh_out_$i  2>>ssh_logs/my_ssh_err_$i &
    i=$(($i+1))
done