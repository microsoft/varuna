...
do
    ...
    sudo ssh -o StrictHostKeyChecking=no -o ServerAliveInterval=120 -i /home/varuna/.ssh/vdummy.pem "varuna@${reachable_machines[i]}" "export PATH=\"/home/varuna/anaconda3/bin:$PATH\"; echo sshed; cd /home/varuna/t-saathl/Varuna/Megatron-LM ; bash examples/pretrain_gpt2.sh $reachable_count $i $master_addr $ckpt" > ssh_logs/my_ssh_out_$i 2>ssh_logs/my_ssh_err_$i &
    i=$(($i+1))
done
