...
CHECKPOINT_PATH=/home/varuna/gpt2-blob/mega_117m_8e-3

NCCL_DEBUG=INFO NCCL_SOCKET_IFNAME=eth0 NCCL_SOCKET_NTHREADS=4 NCCL_NSOCKS_PERTHREAD=4 \
python3 run_varuna.py --nstages 1 --batch_size 8192 --chunk_size 4 --total_num_stages 50 \
       ...
       --eval-interval 100 \
       --eval-iters 10 \
       --loss-file varuna_mega_117m_8e-3 \
       --fp16 --varuna
